        ...
        <div className='bg-white p-3 shadow-2xl px-4 md:px-0'>
            <div className='max-w-6xl mx-auto flex justify-between items-center'>
                ...
                <div className='flex gap-7 items-center'>
                    <Link to={'/'}>
                        <h1 className='font-bold text-3xl'><span className='text-red-500 font-serif'>E</span>-Mart</h1>
                    </Link>
                    ...
                    {
                        openDropDown ? <div className='w-[250px] h-max shadow-2xl z-50 bg-white fixed top-16 left-60 border-2 p-5 border-gray-100 rouded-md'>
                ...
                <nav className='flex gap-7 items-center'>
                    ...
                    <div className='hidden md:block'>
                        <SignedOut>
                            <SignInButton className="bg-red-500 px-3 py-1 rounded-md text-white cursor-pointer"/>
                        </SignedOut>
                        <SignedIn>
                            <UserButton className='avatar'/>
                        </SignedIn>
                    </div>
                    {
